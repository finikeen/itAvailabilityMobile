component output="false" hint="RoleTypes_DAO"
{
	// The name of the relevant entity/bean for this dao
    variables.entityName = "RoleTypes";
    ...
    variables.primaryKeyFieldName = "roleID";
	...
	{
		return ormexecutequery("select count(*) from RoleTypes",true);
	}
}
