component output="false" hint="ApplicationTypes_DAO"
{
    ...
    variables.primaryKeyFieldName = "applicationID";
	...
	{
		return ormexecutequery("select count(*) from ApplicationTypes",true);
	}
}
