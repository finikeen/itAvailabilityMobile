component output="false" hint="ApplicationControl_Service"
{
	variables.dao = APPLICATION.security.objectFactory.getObjectByName("ApplicationControl","dao","security");
