component displayname="AccessControlCollectionsAPI" extends="availability.api.1.resources.AbstractCollectionsAPI" taffy_uri="/AccessControl/"
{	
	variables.service = Application.security.objectFactory.getObjectByName("AccessControl","service","security");
    variables.entityName = "AccessControl";
