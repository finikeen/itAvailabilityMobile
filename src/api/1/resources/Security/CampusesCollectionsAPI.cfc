component displayname="CampusesCollectionsAPI" extends="availability.api.1.resources.AbstractCollectionsAPI" taffy_uri="/Campuses/"
{	
	variables.service = Application.security.objectFactory.getObjectByName("Campuses","service","security");
